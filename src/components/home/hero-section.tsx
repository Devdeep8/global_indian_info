                          ...
                          >
                            <div className="space-y-4">
                              ...
                              <motion.h2
                                ...
                                className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight line-clamp-2"
                              >
                                {item.title}
                              </motion.h2>
                            </div>
                            ...
                            >
                              <Link href={`/articles/${item.slug}`}>
                                <Button
                                  size="lg"
                                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-full px-8 py-6 text-lg shadow-lg hover:shadow-primary/25 transition-all duration-300"
                                >
                                  Read Full Story
                                </Button>
                              </Link>
